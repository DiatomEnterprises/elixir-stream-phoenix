defmodule ElixirStream.ModelCase do
  ...
  def errors_on(changeset) do
    map_errors(changeset)
  end

  defp map_errors(changeset) do
    Ecto.Changeset.traverse_errors(changeset, &ElixirStream.ErrorHelpers.translate_error/1)
